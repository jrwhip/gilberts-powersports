// Footer component with exact functionality from Footer.tsx
        ...
        <div class="mx-auto max-w-7xl px-6 py-12 md:py-16 lg:px-8">
            ...
            <div class="space-y-6">
              ...
              <div class="flex gap-x-8">
                ...
                >
                  ...
                  <svg fill="currentColor" viewBox="0 0 24 24" class="size-8">
                    <path
                      fill-rule="evenodd"
            ...
            <div class="mt-12 lg:col-span-2 lg:mt-0">
              <div class="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <ul role="list" class="space-y-6">
                    <li>
                      <a
                        href="/about"
                        class="text-lg text-gray-100 hover:text-white"
                      >
                        About
                      </a>
                    </li>
                ...
                <div>
                  ...
                  <ul role="list" class="space-y-6">
                    <li class="text-lg text-gray-100">
          ...
          <div class="mt-12 border-t border-white/10 pt-8">
            <div class="flex flex-col md:flex-row md:justify-between">
              ...
              <p class="text-lg text-gray-100 mt-4 md:mt-0">
